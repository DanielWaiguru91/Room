...
class StudentAdapter(private val studentsList: List<Student>, private val clickListener: (Student) -> Unit): RecyclerView.Adapter<StudentAdapter.StudentViewHolder>() {
